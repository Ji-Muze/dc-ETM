...
parser.add_argument('--topic_size', type=list, default=[50, 50, 50, 50, 50], help='Number of units in hidden layer 1.')
...
if args.ppl:
    ...
    if args.use_policy:
        print("Use clustering and policy.")
        trainer = DeepCoupling_Policy_trainer(args, voc_path=voc)
        _best_cluster(args, trainer, test_loader)
    else:
        print("Just clustering.")
        trainer = DeepCoupling_trainer(args, voc_path=voc)
        #_best_cluster(args, trainer, test_loader)
